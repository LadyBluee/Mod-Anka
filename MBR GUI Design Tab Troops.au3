...
$tabTroops = GUICtrlCreateTabItem(GetTranslated(1,1, "Troops"))
	...
	$y =420
	$grpMods = GUICtrlCreateGroup("Çevrimdışı Mod", $x - 20, $y + 2, 150, 65)
	$y +=18
	$chkClearBarracksOnStart = GUICtrlCreateCheckbox("Kampı Doldur", $x - 10, $y, -1, -1)
	  ...
	  $y +=21
	   $chkStayOfflineWhileTrain = GUICtrlCreateCheckbox("Çevrimdışı Kal", $x - 10, $y, -1, -1)
