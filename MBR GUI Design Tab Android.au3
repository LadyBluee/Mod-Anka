...
$tabAndroid = GUICtrlCreateTabItem("Android")
	...
	$grpHideAndroid = GUICtrlCreateGroup("Android Options", $x - 20, $y - 20, 440, 85)
		...
		$chkHideTaskBar = GUICtrlCreateCheckbox("Simgeleri Gizle", $x - 10, $y + 20, 100, -1)
			$txtTip = "This will hide the android client from the taskbar when you press the Hide button"
			GUICtrlSetTip(-1, $txtTip)
			GUICtrlSetOnEvent(-1, "Hide Taskbar Icon")
		$lblHideTaskBar = GUICtrlCreateLabel("Eğer Prpblem Yaratıp Çalışmada Sıkıntı Yaratırsa Butonu Kapatın.", $x + 120, $y + 23, 290, 30, $SS_LEFT)
