...
;~ 			IF $btnColor then GUICtrlSetBkColor(-1, 0x5CAD85)
	...
	Local $x = 30, $y = 355
        $grpDefenseFarming = GUICtrlCreateGroup(GetTranslated(4,79, "Saldýrý Zamanlýyýcýsý"), $x - 20, $y - 20, 220, 170)
		$x -= 10
		$chkattackHours = GUICtrlCreateCheckbox("Þu Saatlerde Saldýr", $x, $y)
		...
		$y += 20
		$chkLogOffIfAttackDisabled = GUICtrlCreateCheckbox("Saldýrý Yoksa Çevrimdýþý Ol", $x, $y)
